...
```{r}
occurrence %<>% mutate(rightsHolder = "Wildlife Montenegro") # e.g. "INBO"
```
### accessRights
...
```{r}
occurrence %<>% mutate(institutionCode = "Wildlife Montenegro") # e.g. "INBO"
```

### datasetName

```{r}
occurrence %<>% mutate(datasetName = "Wildlife Montenegro, mammals in Montenegro") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
